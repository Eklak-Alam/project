...
const Navbar = () => {
  ...
  const handleLinkClick = useCallback((name, href) => {
    setActiveLink(name);
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <ScheduleButton onClick={() => scrollToSection("/")} />
        </div>
...
const ScheduleButton = ({ className, onClick }) => (
  <motion.button
    className={`relative overflow-hidden bg-gradient-to-r from-red-900/20 to-red-800/20 text-white px-6 py-2.5 rounded-full text-sm font-medium border border-red-500/20 hover:border-red-500/40 transition-all duration-300 group ${className}`}
    whileHover={{ 
      scale: 1.05,
  ...
  >
    ...
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500" />
    </div>
