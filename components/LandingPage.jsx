...
export default function LandingPage() {
  return (
    <div id="Home" className="flex flex-col overflow-hidden ">
      {/* Fixed Text at Top */}
      <div className="text-center px-4 md:pt-32 pt-32 lg:pt-36">
        {/* Main Title */}
        <motion.h1
        ...
        <motion.p
          ...
          className="mt-4 text-lg md:text-xl text-gray-400 font-bold"
        >
        ...
        titleComponent={
          <div className="flex justify-center">
            <motion.button
              ...
              className="py-3 px-2 md:px-8 md:py-4 bg-red-600 text-white font-semibold 
                        text-sm md:text-xl rounded-full shadow-xl transition-all 
